...
Blockly.Msg.OXOCARD_COMM_GET_BROADCAST_NUMBER_TIP = 'Reads the value of the defined variable or the sender ID of the received message';
...
Blockly.Msg.OXOCARD_COMM_ADD_SENDER_ID_TO_WHITELIST_TITLE = 'Add sender ID to the sender filter';
Blockly.Msg.OXOCARD_COMM_ADD_SENDER_ID_TO_WHITELIST_TIP = 'Adds single sender ID to the sender filter';
...
Blockly.Msg.OXOCARD_COMM_ADD_RECEIVER_ID_TO_LIST_TITLE = 'Add receiver ID to the receiver list';
Blockly.Msg.OXOCARD_COMM_ADD_RECEIVER_ID_TO_LIST_TIP = 'Adds single receiver ID to the receiver list';
