...
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_SENDER_WHITELIST_TITLE = "Set sender whitelist";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_SENDER_WHITELIST_TIP = "Sets the sender whitelist with one or more names (e.g. \"Oxocard20, Tim\") or IDs (e.g. \"#42, #15, #8\"). To reset the list, leave the input field empty or write a *";
