...
/** @export */ Blockly.Msg.OXOCARD_COMM_ENABLE_TITLE2 = "and ID";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_GET_BROADCAST_NUMBER_TIP = "Reads the value of the defined variable or the sender ID of the received message";
/** @export */ Blockly.Msg.OXOCARD_COMM_GET_BROADCAST_NUMBER_TITLE = "read received variable";
/** @export */ Blockly.Msg.OXOCARD_COMM_GET_BROADCAST_NUMBER_SENDER_ID = "Sender ID";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_SENDER_WHITELIST_TITLE = "Set sender filter";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_SENDER_WHITELIST_TIP = "Sets the sender filter with one or more names (e.g. \"Oxocard20, Tim, James\"). To reset the list, leave the input field empty or write a *";
/** @export */ Blockly.Msg.OXOCARD_COMM_ADD_SENDER_ID_TO_WHITELIST_TITLE = "Add sender ID to the sender filter";
/** @export */ Blockly.Msg.OXOCARD_COMM_ADD_SENDER_ID_TO_WHITELIST_TIP = "Adds single sender ID to the sender filter";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_RECEIVER_LIST_TITLE = "Set receiver list";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_RECEIVER_LIST_TIP = "Sets the receiver list with one or more names (e.g. \"Oxocard20, Tim, James\"). To reset the list, leave the input field empty or write a *";
/** @export */ Blockly.Msg.OXOCARD_COMM_ADD_RECEIVER_ID_TO_LIST_TITLE = "Add receiver ID to the receiver list";
/** @export */ Blockly.Msg.OXOCARD_COMM_ADD_RECEIVER_ID_TO_LIST_TIP = "Adds single receiver ID to the receiver list";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_WAIT_FOR_MESSAGE_TIMEOUT_MS_FIELD = "with timeout [ms]";
...
/** @export */ Blockly.Msg.OXOCARD_READ_BATTERY_VOLTAGE_TIP = "Reads the battery voltage in millivolt";
