...
/** @export */ Blockly.Msg.ARD_ANALOGREAD_TIP = "Returns value between 0 and 1024";
/** @export */ Blockly.Msg.ARD_ANALOGWRITE = "set analog pin#";
/** @export */ Blockly.Msg.ARD_ANALOGWRITE_TIP = "Writes analog value between 0 and 255 to a specific PWM Port";
/** @export */ Blockly.Msg.ARD_BUILTIN_LED = "set built-in LED";
/** @export */ Blockly.Msg.ARD_BUILTIN_LED_TIP = "Lights on or off for the built-in LED of the Arduino";
...
/** @export */ Blockly.Msg.ARD_DIGITALREAD_TIP = "Reads digital value on a pin: HIGH or LOW";
/** @export */ Blockly.Msg.ARD_DIGITALWRITE = "set digitial pin#";
/** @export */ Blockly.Msg.ARD_DIGITALWRITE_TIP = "Writes digital value HIGH or LOW to a specific Port";
...
/** @export */ Blockly.Msg.ARD_HIGHLOW_TIP = "Sets a pin state logic High or Low.";
...
/** @export */ Blockly.Msg.ARD_NOTONE_PIN_TIP = "Stops generating a tone on a pin";
...
/** @export */ Blockly.Msg.ARD_SERVO_READ_TIP = "Reads a Servo angle";
/** @export */ Blockly.Msg.ARD_SERVO_WRITE = "set SERVO from Pin";
/** @export */ Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "Degrees (0~180)";
/** @export */ Blockly.Msg.ARD_SERVO_WRITE_TIP = "Sets a Servo to an specified angle";
...
/** @export */ Blockly.Msg.ARD_SPI_TRANS_TIP = "Sends a SPI message to an specified slave device.";
...
/** @export */ Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "Waits specific time in microseconds";
/** @export */ Blockly.Msg.ARD_TIME_DELAY_TIP = "Waits specific time in milliseconds";
/** @export */ Blockly.Msg.ARD_TIME_INF = "wait forever (end program)";
/** @export */ Blockly.Msg.ARD_TIME_INF_TIP = "Waits indefinitely, stopping the program.";
...
/** @export */ Blockly.Msg.ARD_TONE_PIN_TIP = "Generates audio tones on a pin";
...
/** @export */ Blockly.Msg.CONTROLS_IF_MSG_THEN = "then";
...
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Returns true if both inputs equal each other.";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "Returns true if the first input is greater than the second input.";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "Returns true if the first input is greater than or equal to the second input.";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT = "Returns true if the first input is smaller than the second input.";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "Returns true if the first input is smaller than or equal to the second input.";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "Returns true if both inputs are not equal to each other.";
...
/** @export */ Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "Returns true if both inputs are true.";
/** @export */ Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "Returns true if at least one of the inputs is true.";
...
/** @export */ Blockly.Msg.OXOCARD_AP_MODE_TIP = "Puts the Oxocard into the configuration/ap-mode. After connecting to the WiFi you can configure the Oxocard.";
/** @export */ Blockly.Msg.OXOCARD_AP_MODE_TITLE = "Configuration mode";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_GET_VOLUME_TIP = "Gets the volume from the audio output";
...
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_SOUND_EFFECT_TIP = "Plays a selected sound effect once or forever";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_SOUND_EFFECT_TITLE = "Play sound effect";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_TONE_HZ_TIP = "Plays a tone in Hertz";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_TONE_HZ_TITLE = "Play tone (Hertz)";
...
/** @export */ Blockly.Msg.OXOCARD_AUDIO_RECORD_FOR_TIP = "Records audio data for given time in milliseconds";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_RECORD_FOR_TITLE = "Record for";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_SET_BPM_TIP = "Sets the global beats per minute (BPM)";
...
/** @export */ Blockly.Msg.OXOCARD_AUDIO_SET_VOLUME_TIP = "Sets the voume of the audio output";
...
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_FOR_LOUD_NOISE_TIP = "Waits until a loud noise is measured by the microphone";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_FOR_LOUD_NOISE_TITLE = "Wait for a loud noise";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_FOR_TONE_TIP = "Waits after every following tone";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_FOR_TONE_TITLE = "Wait after tones";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_NOT_FOR_TONE_TIP = "Does not wait after every following tone";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_NOT_FOR_TONE_TITLE = "Continue after tones";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_TIP = "Waits for a given tone duration";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_TITLE = "Wait";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAVE_SAWTOOTH = "Sawtooth";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAVE_SINE = "Sine";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAVE_SQUARE = "Square";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAVE_TRIANGLE = "Triangle";
/** @export */ Blockly.Msg.OXOCARD_AUTO_TURNOFF_TIMEOUT_FIELD = "with timeout [s]";
/** @export */ Blockly.Msg.OXOCARD_AUTO_TURNOFF_TIP = "Enters sleep mode after given timeout";
/** @export */ Blockly.Msg.OXOCARD_AUTO_TURNOFF_TITLE = "Handle auto turnoff";
/** @export */ Blockly.Msg.OXOCARD_AUTO_TURNOFF_WP_TIP = "Enters sleep mode after 2 minutes";
/** @export */ Blockly.Msg.OXOCARD_AUTO_TURNOFF_WP_TITLE = "Handle auto turnoff";
/** @export */ Blockly.Msg.OXOCARD_BUTTON_ANY = "Any";
/** @export */ Blockly.Msg.OXOCARD_BUTTON_L1 = "L1 (top left)";
/** @export */ Blockly.Msg.OXOCARD_BUTTON_L2 = "L2 (bottom left outside)";
/** @export */ Blockly.Msg.OXOCARD_BUTTON_L3 = "L3 (bottom left inside)";
/** @export */ Blockly.Msg.OXOCARD_BUTTON_PRESSED_TIP = "Checks if the button is pressed; Returns true or false";
...
/** @export */ Blockly.Msg.OXOCARD_BUTTON_WAITFORPRESSED_TIP = "Waits until the button is pressed";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_BROADCAST_TIP = "Checks whether the received message is new and permitted";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_BROADCAST_TITLE = "new message received?";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_DIRECT_TIP = "Checks whether a new direct message has been received";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_DIRECT_TITLE1 = "new direct message";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_DIRECT_TITLE2 = "received?";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_SENDER_TIP = "Checks whether the received message is from the given sender";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_MESSAGE_TIP = "Compares the received message with the given message";
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_MESSAGE_TITLE = "compare received message";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_GET_BROADCAST_NUMBER_TIP = "Reads value of the defined variable of the received message";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_IS_MESSAGE_FOR_ME_TIP = "Checks whether the received message is for me";
/** @export */ Blockly.Msg.OXOCARD_COMM_IS_MESSAGE_FOR_ME_TITLE = "is message for me?";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_MESSAGE_TIP = "Sends a broadcast message with the given text";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_MESSAGE_TITLE = "Send broadcast message";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_NUMBER_TIP = "Broadcasts a number to every Oxocard";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_DIRECT_MESSAGE_TIP = "Sends a message to the specified Oxocard";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_DIRECT_MESSAGE_TITLE = "Send direct message";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_DIRECT_NUMBER_TIP = "Sends a number to the specified Oxocard";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_MESSAGE_TITLE = "Send message";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_MESSAGE_TO_TIP = "Sends a message with previously defined text and variables to one or more receivers (e.g. 'Oxocard20, Tim, James' or a '*' to locally send to all participants)";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_COMMUNICATION_TYPE_TIP = "Sets the communication type to either local (within the same network) or global (internet)";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_COMMUNICATION_TYPE_TITLE = "Set communication type";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_COMMUNICATION_TYPE_TYPE1 = "Local (faster, WLAN only)";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_COMMUNICATION_TYPE_TYPE2 = "Global (slower, worldwide)";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_USER_VALUE_TIP = "Sets the value of a variable to be sent";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_USER_VALUE_TITLE = "Set message variable";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_USER_VALUE_WITH = "with";
/** @export */ Blockly.Msg.OXOCARD_COMM_WAIT_FOR_MESSAGE_TIMEOUT_FIELD = "with timeout [s]";
/** @export */ Blockly.Msg.OXOCARD_COMM_WAIT_FOR_MESSAGE_TIMEOUT_TIP = "Waits a given time for a message";
...
/** @export */ Blockly.Msg.OXOCARD_DIGITAL_READ_TIP = "Reads the state of the choosen IO pin";
/** @export */ Blockly.Msg.OXOCARD_DIGITAL_READ_TITLE = "read pin";
/** @export */ Blockly.Msg.OXOCARD_DIGITAL_WRITE_TIP = "Sets the state of the choosen IO pin";
/** @export */ Blockly.Msg.OXOCARD_DIGITAL_WRITE_TITLE = "Set pin";
/** @export */ Blockly.Msg.OXOCARD_DRAW_CHAR_TIP = "Draws single character (A - Z)";
/** @export */ Blockly.Msg.OXOCARD_DRAW_CHAR_TITLE = "Draw char";
/** @export */ Blockly.Msg.OXOCARD_DRAW_DIGIT_TIP = "Draws single digit (0 - 9)";
/** @export */ Blockly.Msg.OXOCARD_DRAW_DIGIT_TITLE = "Draw digit";
/** @export */ Blockly.Msg.OXOCARD_DRAW_NUMBER_TIP = "Draws a number (0 - 99)";
/** @export */ Blockly.Msg.OXOCARD_DRAW_NUMBER_TITLE = "Draw number";
/** @export */ Blockly.Msg.OXOCARD_FILL_DISPLAY_TIP = "Writes value between 0 and 255";
/** @export */ Blockly.Msg.OXOCARD_FILL_DISPLAY_TITLE = "Fill display";
/** @export */ Blockly.Msg.OXOCARD_FIND_IBEACON_TIP = "Search for iBeacons with the given ID";
/** @export */ Blockly.Msg.OXOCARD_FIND_IBEACON_TITLE = "Find iBeacon with the ID";
/** @export */ Blockly.Msg.OXOCARD_GET_ACCELERATION_TIP = "Returns the selected accelerometer axis value";
/** @export */ Blockly.Msg.OXOCARD_GET_ACCELERATION_TITLE = "get acceleration";
/** @export */ Blockly.Msg.OXOCARD_GET_CURSOR_VALUE_TIP = "Gets the x- or y-value of the cursor";
/** @export */ Blockly.Msg.OXOCARD_GET_CURSOR_VALUE_TITLE = "get cursor ";
/** @export */ Blockly.Msg.OXOCARD_GET_ORIENTATION_TIP = "Returns the orientation of the Oxocard";
/** @export */ Blockly.Msg.OXOCARD_GET_ORIENTATION_TITLE = "get orientation";
/** @export */ Blockly.Msg.OXOCARD_GET_TIMER_SECONDS_TIP = "Returns the seconds of the timer";
/** @export */ Blockly.Msg.OXOCARD_GET_TIMER_SECONDS_TITLE = "Get timer seconds";
/** @export */ Blockly.Msg.OXOCARD_IS_BATTERY_FULLY_CHARGED_TIP = "Returns true if battery is fully charged";
/** @export */ Blockly.Msg.OXOCARD_IS_BATTERY_FULLY_CHARGED_TITLE = "is battery fully charged?";
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_DOWN_FIELD = "Down";
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_HALF_DOWN_FIELD = "Tilt down";
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_HALF_LEFT_FIELD = "Tilt left";
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_HALF_RIGHT_FIELD = "Tilt right";
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_HALF_UP_FIELD = "Tilt up";
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_HORIZONTALLY_FIELD = "Horizontally";
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_TIP = "Returns if the Oxocard is in the given orientation";
...
/** @export */ Blockly.Msg.OXOCARD_IS_USB_PLUGGED_IN_TIP = "Returns true if USB cable is plugged in";
/** @export */ Blockly.Msg.OXOCARD_IS_USB_PLUGGED_IN_TITLE = "is USB cable plugged in?";
/** @export */ Blockly.Msg.OXOCARD_LIST_ADD_COLOR_TIP = "Append given value to the color list";
/** @export */ Blockly.Msg.OXOCARD_LIST_ADD_COLOR_TITLE2 = "to the color list";
/** @export */ Blockly.Msg.OXOCARD_LIST_ADD_TIP = "Append given value to the list";
/** @export */ Blockly.Msg.OXOCARD_LIST_ADD_TITLE1 = "Append";
/** @export */ Blockly.Msg.OXOCARD_LIST_ADD_TITLE1_5 = " value";
/** @export */ Blockly.Msg.OXOCARD_LIST_ADD_TITLE2 = "to the list";
/** @export */ Blockly.Msg.OXOCARD_LIST_GET_COLOR_TIP = "Get defined element from the color list";
/** @export */ Blockly.Msg.OXOCARD_LIST_GET_COLOR_TITLE2 = "from the color list";
/** @export */ Blockly.Msg.OXOCARD_LIST_GET_TIP = "Get defined element from the list";
/** @export */ Blockly.Msg.OXOCARD_LIST_GET_TITLE1 = "Get element No.";
/** @export */ Blockly.Msg.OXOCARD_LIST_GET_TITLE2 = "from the list";
/** @export */ Blockly.Msg.OXOCARD_LIST_REMOVE_COLOR_TIP = "Remove defined element from the color list";
/** @export */ Blockly.Msg.OXOCARD_LIST_REMOVE_COLOR_TITLE2 = "from the color list";
/** @export */ Blockly.Msg.OXOCARD_LIST_REMOVE_TIP = "Remove defined element from the list";
/** @export */ Blockly.Msg.OXOCARD_LIST_REMOVE_TITLE1 = "Remove element No.";
/** @export */ Blockly.Msg.OXOCARD_LIST_REMOVE_TITLE2 = "from the list";
/** @export */ Blockly.Msg.OXOCARD_PUS_HAS_VARIABLE_TITLE1 = "is persistent variable";
/** @export */ Blockly.Msg.OXOCARD_PUS_HAS_VARIABLE_TITLE2 = "set?";
/** @export */ Blockly.Msg.OXOCARD_PUS_HAS_VARIABLE_TIP = "Checks if defined variable is set in the persistent memory";
/** @export */ Blockly.Msg.OXOCARD_PUS_SET_VARIABLE_TITLE = "Set persistent variable";
/** @export */ Blockly.Msg.OXOCARD_PUS_SET_VARIABLE_WITH = "with";
/** @export */ Blockly.Msg.OXOCARD_PUS_SET_VARIABLE_TIP = "Sets defined variable in the persistent memory";
/** @export */ Blockly.Msg.OXOCARD_PUS_GET_VARIABLE_TITLE = "get persistent variable";
/** @export */ Blockly.Msg.OXOCARD_PUS_GET_VARIABLE_TIP = "Gets defined variable from the persistent memory";
/** @export */ Blockly.Msg.OXOCARD_PUS_DELETE_VARIABLE_TITLE = "Delete persistent variable";
/** @export */ Blockly.Msg.OXOCARD_PUS_DELETE_VARIABLE_TIP = "Deletes defined variable from the persistent memory";
/** @export */ Blockly.Msg.OXOCARD_LOGIC_OPERATION_AND = "and";
/** @export */ Blockly.Msg.OXOCARD_LOGIC_OPERATION_OR = "or";
/** @export */ Blockly.Msg.OXOCARD_LOGIC_WHILE_FOREVER_TIP = "Endless loop: Repeats the used blocks inside forever";
/** @export */ Blockly.Msg.OXOCARD_LOGIC_WHILE_FOREVER_TITLE = "Do forever";
/** @export */ Blockly.Msg.OXOCARD_MATH_DECREMENT_TIP = "Subtracts 1 to the value of the specified variable.";
/** @export */ Blockly.Msg.OXOCARD_MATH_DECREMENT_TITLE = "Substract 1 from";
/** @export */ Blockly.Msg.OXOCARD_MATH_INCREMENT_TIP = "Adds 1 to the value of the specified variable.";
/** @export */ Blockly.Msg.OXOCARD_MATH_INCREMENT_TITLE = "Add 1 to";
/** @export */ Blockly.Msg.OXOCARD_MATH_SET_VAR_WITH_TIP = "Sets a variable with an expression (e.g. 1*(5/8))";
/** @export */ Blockly.Msg.OXOCARD_MATH_SET_VAR_WITH_TITLE = "Set";
/** @export */ Blockly.Msg.OXOCARD_MATH_SET_VAR_WITH_TITLE2 = "with";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_CLEAR_PIXEL_TIP = "Clears the pixel on the defined coordinates";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_CLEAR_PIXEL_TITLE = "Clear pixel";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_CLEAR_TIP = "Clears all pixels on the matrix";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_ALL_TIP = "Draws all pixels";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_IMAGE_TIP = "Turns on specific pixels";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_LINE_TIP = "Draws a line based on the specified coordinates";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_LINE_TITLE = "Draw line";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_LINE_TO = "To";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_NUMBER_TIP = "Draws a number on the display";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_NUMBER_TITLE = "Draw number";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_PIXEL_TIP = "Draws the pixel on the defined coordinates";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_RGB_IMAGE_TIP = "Turns on specific pixels with different colors";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_TEXT_TIP = "Draws a given text on the display";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_COLOR_TIP = "The following draw-blocks will draw the specified color";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_FILL_TIP = "The geometric shapes are drawn filled in.";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_FILL_TITLE = "Fill";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_NOFILL_TIP = "The geometric shapes are not drawn filled in.";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_NOFILL_TITLE = "No fill";
...
/** @export */ Blockly.Msg.OXOCARD_NO_AUTO_TURNOFF_TIP = "Disables the auto turnoff functionality";
/** @export */ Blockly.Msg.OXOCARD_NO_AUTO_TURNOFF_TITLE = "Disable auto turnoff";
/** @export */ Blockly.Msg.OXOCARD_NO_TONE_TIP = "Stops the tone";
/** @export */ Blockly.Msg.OXOCARD_NO_TONE_TITLE = "No tone";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_DOWN = "Down";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_FLAT = "Flat";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_FLAT_FLIPPED = "Flat Flipped";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_HALF_DOWN = "Halfway Down";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_HALF_LEFT = "Halfway Left";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_HALF_RIGHT = "Halfway Right";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_HALF_UP = "Halfway Up";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_LEFT = "Left";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_RIGHT = "Right";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_UP = "Up";
/** @export */ Blockly.Msg.OXOCARD_PAIRING_MODE_TIP = "Puts the Oxocard into the pairing-mode such that the Oxocard can be paired with blockly.";
/** @export */ Blockly.Msg.OXOCARD_PAIRING_MODE_TITLE = "Pair with blockly";
...
/** @export */ Blockly.Msg.OXOCARD_RANDOM_TIP = "Returns a random number between (and with) the first given value to (and with) the second value";
/** @export */ Blockly.Msg.OXOCARD_RANDOM_TITLE1 = "Random from";
/** @export */ Blockly.Msg.OXOCARD_RANDOM_TITLE2 = "to";
/** @export */ Blockly.Msg.OXOCARD_READ_BATTERY_VOLTAGE_TIP = "Reads the battery voltage in V";
/** @export */ Blockly.Msg.OXOCARD_READ_BATTERY_VOLTAGE_TITLE = "read battery voltage [mV]";
/** @export */ Blockly.Msg.OXOCARD_READ_TEMPERATURE_TIP = "Reads the temperature in °C (+/- 2°C precision)";
/** @export */ Blockly.Msg.OXOCARD_READ_TEMPERATURE_TITLE = "read temperature [°C]";
/** @export */ Blockly.Msg.OXOCARD_REBOOT_TIP = "Resets the Oxocard";
/** @export */ Blockly.Msg.OXOCARD_REBOOT_TITLE = "Reset Oxocard";
...
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_VALUE_SECOND = "second";
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_VALUE_TIP = "Gets a specific value from the time (e.g. seconds)";
...
/** @export */ Blockly.Msg.OXOCARD_TIME_SET_MANUAL_HOUR = "Hour";
/** @export */ Blockly.Msg.OXOCARD_TIME_SET_MANUAL_MINUTE = "Minute";
/** @export */ Blockly.Msg.OXOCARD_TIME_SET_MANUAL_SECOND = "Second";
/** @export */ Blockly.Msg.OXOCARD_TIME_SET_MANUAL_TIP = "Updates the internal clock of the Oxocard to the provided values";
/** @export */ Blockly.Msg.OXOCARD_TIME_SET_MANUAL_TITLE = "Set internal clock to";
...
/** @export */ Blockly.Msg.OXOCARD_TONE_TIP = "Plays a tone for a specified time";
/** @export */ Blockly.Msg.OXOCARD_TONE_TITLE = "Play tone";
/** @export */ Blockly.Msg.OXOCARD_TURN_DISPLAY_ON_TIP = "Turns the whole display on";
...
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_AND_DRAW_CITY_TIP = "Draws the name of the city from the weather data";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_AND_DRAW_CITY_TITLE = "Draw city name";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_FROM_TIP = "Gets the weather data from the selected city";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_FROM_TITLE = "Get weather data from";
...
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_PRECIPITATION = "Precipitation (mm)";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_TEMP = "Temperature (°C)";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_TIP = "Reads a value from the weather data";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_TITLE = "read";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_WIND = "Wind (km/h)";
/** @export */ Blockly.Msg.OXOCARD_WIFI_CAN_CONNECT_TO_INTERNET_TIP = "This returns true if the card can connect with the internet.";
/** @export */ Blockly.Msg.OXOCARD_WIFI_CAN_CONNECT_TO_INTERNET_TITLE = "Can connect with WiFi?";
