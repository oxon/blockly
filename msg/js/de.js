...
/** @export */ Blockly.Msg.ARD_SERVO_WRITE_TIP = "Set a Servo to a specified angle";
...
/** @export */ Blockly.Msg.ARD_TIME_DELAY_TIP = "Wartet angegebene Dauer (in Millisekunden)";
...
/** @export */ Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "sonst wenn";
/** @export */ Blockly.Msg.CONTROLS_IF_MSG_IF = "Wenn";
/** @export */ Blockly.Msg.CONTROLS_IF_MSG_THEN = "dann";
...
/** @export */ Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "Führt die eingesetzten Blöcke aus, bis die Bedingung erfüllt ist";
/** @export */ Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "Führt die eingesetzten Blöcke aus, solange die Bedingung erfüllt ist";
...
/** @export */ Blockly.Msg.LISTS_INDEX_OF_TOOLTIP = "Sucht die Position (Index) eines Elementes in der Liste. Liefert %1, falls kein Element gefunden wurde";
...
/** @export */ Blockly.Msg.LISTS_ISEMPTY_TOOLTIP = "Liefert wahr, falls die Liste leer ist";
...
/** @export */ Blockly.Msg.LOGIC_BOOLEAN_TOOLTIP = "Liefert entweder wahr oder falsch";
...
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Liefert wahr, falls beide Werte gleich sind";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "Liefert wahr, falls der erste Wert größer als der zweite Wert ist";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "Liefert wahr, falls der erste Wert größer als oder gleich groß wie der zweite Wert ist";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT = "Liefert wahr, falls der erste Wert kleiner als der zweite Wert ist";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "Liefert wahr, falls der erste Wert kleiner als oder gleich groß wie der zweite Wert ist";
/** @export */ Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "Liefert wahr, falls beide Werte unterschiedlich sind";
...
/** @export */ Blockly.Msg.LOGIC_NEGATE_TOOLTIP = "Liefert wahr, falls der Eingabewert falsch ist. Liefert falsch, falls der Eingabewert wahr ist";
...
/** @export */ Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "Liefert wahr, falls beide Werte wahr sind";
/** @export */ Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "Liefert wahr, falls einer der beiden Werte wahr ist";
...
/** @export */ Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "Überprüft eine Bedingung \"prüfe\". Falls die Bedingung wahr ist, wird der \"falls wahr\" Wert zurückgegeben, andernfalls der \"falls falsch\" Wert";
...
/** @export */ Blockly.Msg.MATH_IS_TOOLTIP = "Überprüft ob eine Zahl gerade, ungerade, eine Primzahl, ganzzahlig, positiv, negativ oder durch eine zweite Zahl teilbar ist. Liefert wahr oder falsch";
...
/** @export */ Blockly.Msg.MATH_MODULO_TOOLTIP = "Liefert den Rest nach einer Division.";
...
/** @export */ Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM = "Liefert einen zufälligen Wert aus der Liste";
...
/** @export */ Blockly.Msg.OXOCARD_AP_MODE_TIP = "Versetzt die Oxocard in den Konfigurations-Modus (Accesspoint-Modus). Nachdem Du deinen Computer mit dem WiFi der Oxocard verbunden hast, kannst Du sie in einem Browser unter http://192.168.4.1 konfigurieren";
...
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_RECORDED_TITLE = "Spiele das Aufgenommene";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_SOUND_EFFECT_TIP = "Spielt den ausgewählten Soundeffekt einmal oder für immer";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_SOUND_EFFECT_TITLE = "Spiele Soundeffekt";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_TONE_HZ_TIP = "Spielt einen Ton mit der angegebenen Frequenz";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_TONE_HZ_TITLE = "Spiele Ton (Hertz)";
...
/** @export */ Blockly.Msg.OXOCARD_AUDIO_PLAY_TONE_TITLE = "Spiele Ton der Tonleiter";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_RECORD_FOR_TIP = "Nimmt Audiodaten für die definierte Zeitdauer auf";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_RECORD_FOR_TITLE = "Nimm auf für";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_SET_BPM_TIP = "Setzt den globalen Takt in BPM";
...
/** @export */ Blockly.Msg.OXOCARD_AUDIO_SET_VOLUME_TIP = "Stellt die Lautstärke des Audio-Ausgangs ein";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_SET_VOLUME_TITLE = "Setze Lautstärke";
...
/** @export */ Blockly.Msg.OXOCARD_AUDIO_STOP_TONE_TITLE = "Stoppe Ton";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_VOLUME_DOWN_TIP = "Verringert die Lautstärke um 1/16 der Maximallautstärke";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_VOLUME_DOWN_TITLE = "Verringere Lautstärke";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_VOLUME_UP_TIP = "Erhöht die Lautstärke um 1/16 der Maximallautstärke";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_VOLUME_UP_TITLE = "Erhöhe Lautstärke";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_FOR_LOUD_NOISE_TIP = "Wartet, bis ein lautes Geräusch vom Mikrofon registriert wird";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_FOR_LOUD_NOISE_TITLE = "Warte auf lautes Geräusch";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_FOR_TONE_TIP = "Wartet nach jedem Ton, bis er fertig gespielt wurde";
...
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_TIP = "Wartet für die angegebene Tondauer";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAIT_TITLE = "Warte";
/** @export */ Blockly.Msg.OXOCARD_AUDIO_WAVE_SAWTOOTH = "Sägezahn";
...
/** @export */ Blockly.Msg.OXOCARD_BUTTON_L1 = "L1 (Links oben)";
/** @export */ Blockly.Msg.OXOCARD_BUTTON_L2 = "L2 (Links unten aussen)";
/** @export */ Blockly.Msg.OXOCARD_BUTTON_L3 = "L3 (Links unten innen)";
/** @export */ Blockly.Msg.OXOCARD_BUTTON_PRESSED_TIP = "Prüft, ob der Knopf gedrückt ist; Liefert wahr oder falsch";
...
/** @export */ Blockly.Msg.OXOCARD_COMMENT_TITLE = "Kommentar";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_BROADCAST_TIP = "Prüft, ob eine neue erlaubte Kurznachricht eingetroffen ist";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_BROADCAST_TITLE = "neue Kurznachricht empfangen?";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_DIRECT_TIP = "Prüft, ob eine neue Kurznachricht eingetroffen ist";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_DIRECT_TITLE1 = "neue Kurznachricht";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_FOR_DIRECT_TITLE2 = "empfangen?";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_SENDER_TIP = "Prüft, ob die empfangene Kurznachricht vom angegebenem Absender ist";
/** @export */ Blockly.Msg.OXOCARD_COMM_CHECK_SENDER_TITLE = "ist empfangene Kurznachricht von";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_BROADCAST_MESSAGE_TIP = "Vergleicht die empfangene Broadcast-Nachricht mit dem angegebenen Text";
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_BROADCAST_MESSAGE_TITLE = "vergleiche Broadcast-Nachricht";
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_BROADCAST_NUMBER_TIP = "Vergleicht die empfangene Zahl mit dem angegebenen Wert";
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_BROADCAST_NUMBER_TITLE = "vergleiche Broadcast-Zahl";
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_DIRECT_MESSAGE_FROM = "von";
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_DIRECT_MESSAGE_TIP = "Vergleicht die empfangene Kurznachricht mit dem angegebenen Text";
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_DIRECT_MESSAGE_TITLE = "vergleiche Kurznachricht";
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_DIRECT_NUMBER_TIP = "Vergleicht die empfangene Zahl mit dem angegebenen Wert";
/** @export */ Blockly.Msg.OXOCARD_COMM_COMPARE_DIRECT_NUMBER_TITLE = "vergleiche Zahl";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_IS_MESSAGE_FOR_ME_TIP = "Prüft, ob die empfangene Kurznachricht für mich ist";
/** @export */ Blockly.Msg.OXOCARD_COMM_IS_MESSAGE_FOR_ME_TITLE = "ist empfangene Kurznachricht für mich?";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_MESSAGE_TIP = "Sendet eine Broadcast-Nachricht mit dem angegebenen Text";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_MESSAGE_TITLE = "Sende Broadcast-Nachricht";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_NUMBER_TIP = "Sendet eine Zahl an alle Oxocards";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_BROADCAST_NUMBER_TITLE = "Sende Broadcast-Zahl";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_DIRECT_MESSAGE_AT = "an";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_DIRECT_MESSAGE_TIP = "Sendet eine Kurznachricht an die angegebene Oxocard";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_DIRECT_MESSAGE_TITLE = "Sende Kurznachricht";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_MESSAGE_TIP = "Sendet eine Kurznachricht mit vorher definiertem Text und Variablen";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_MESSAGE_TITLE = "Versende Kurznachricht";
/** @export */ Blockly.Msg.OXOCARD_COMM_SEND_MESSAGE_TO_TIP = "Sendet eine Kurznachricht mit vorher definiertem Text und Variablen an einen oder mehreren Empfänger (z.B. \"Oxocard20, Tim, James\" oder ein \"*\" um lokal an alle Teilnehmer zu senden)";
...
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_RECEIVER_LIST_TITLE = "Setze Empfänger";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_USER_MESSAGE_TIP = "Setzt die zu versendende Textnachricht";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_USER_MESSAGE_TITLE = "Setze Kurznachricht-Text";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_USER_VALUE_TIP = "Setzt den Wert einer zu versendenden Variable";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_USER_VALUE_TITLE = "Setze Kurznachricht-Variable";
/** @export */ Blockly.Msg.OXOCARD_COMM_SET_USER_VALUE_WITH = "mit";
/** @export */ Blockly.Msg.OXOCARD_COMM_WAIT_FOR_MESSAGE_TIMEOUT_FIELD = "mit Timeout [s]";
...
/** @export */ Blockly.Msg.OXOCARD_DIGITAL_READ_TIP = "Liefert den Zustand des ausgewählten IO Pins";
/** @export */ Blockly.Msg.OXOCARD_DIGITAL_READ_TITLE = "lies Pin";
/** @export */ Blockly.Msg.OXOCARD_DIGITAL_WRITE_TIP = "Setzt den Zustand des ausgewählten IO Pins";
/** @export */ Blockly.Msg.OXOCARD_DIGITAL_WRITE_TITLE = "Setze Pin";
...
/** @export */ Blockly.Msg.OXOCARD_DRAW_DIGIT_TIP = "Schreibt eine einzelne Zahl";
/** @export */ Blockly.Msg.OXOCARD_DRAW_DIGIT_TITLE = "Zahl";
/** @export */ Blockly.Msg.OXOCARD_DRAW_NUMBER_TIP = "Zeichnet angegebene Zahl";
/** @export */ Blockly.Msg.OXOCARD_DRAW_NUMBER_TITLE = "Zeichne Zahl";
...
/** @export */ Blockly.Msg.OXOCARD_GET_ACCELERATION_TIP = "Liefert die Beschleunigung um die angegebene Achse";
/** @export */ Blockly.Msg.OXOCARD_GET_ACCELERATION_TITLE = "hole Beschleunigung";
/** @export */ Blockly.Msg.OXOCARD_GET_CURSOR_VALUE_TIP = "Holt die aktuelle Beschleunigungsposition in der Matrix";
/** @export */ Blockly.Msg.OXOCARD_GET_CURSOR_VALUE_TITLE = "hole Cursor ";
/** @export */ Blockly.Msg.OXOCARD_GET_ORIENTATION_TIP = "Returns the orientation of the Oxocard";  // untranslated
...
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_HALF_DOWN_FIELD = "Nach unten geneigt";
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_HALF_LEFT_FIELD = "Nach links geneigt";
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_HALF_RIGHT_FIELD = "Nach rechts geneigt";
/** @export */ Blockly.Msg.OXOCARD_IS_ORIENTATION_HALF_UP_FIELD = "Nach oben geneigt";
...
/** @export */ Blockly.Msg.OXOCARD_LIST_ADD_TITLE1 = "Füge";
/** @export */ Blockly.Msg.OXOCARD_LIST_ADD_TITLE1_5 = " Wert";
/** @export */ Blockly.Msg.OXOCARD_LIST_ADD_TITLE2 = "der Liste hinzu";
/** @export */ Blockly.Msg.OXOCARD_LIST_GET_COLOR_TIP = "Hole das definierte Element von der Farben-Liste";
/** @export */ Blockly.Msg.OXOCARD_LIST_GET_COLOR_TITLE2 = "von der Farben-Liste";
/** @export */ Blockly.Msg.OXOCARD_LIST_GET_TIP = "Hole das definierte Element von der Liste";
/** @export */ Blockly.Msg.OXOCARD_LIST_GET_TITLE1 = "Hole Element Nr.";
/** @export */ Blockly.Msg.OXOCARD_LIST_GET_TITLE2 = "von der Liste";
/** @export */ Blockly.Msg.OXOCARD_LIST_REMOVE_COLOR_TIP = "Entfernt das definierte Element von der Farben-Liste";
/** @export */ Blockly.Msg.OXOCARD_LIST_REMOVE_COLOR_TITLE2 = "von der Farben-Liste";
/** @export */ Blockly.Msg.OXOCARD_LIST_REMOVE_TIP = "Entfernt das definierte Element von der Liste";
/** @export */ Blockly.Msg.OXOCARD_LIST_REMOVE_TITLE1 = "Entferne Element Nr.";
/** @export */ Blockly.Msg.OXOCARD_LIST_REMOVE_TITLE2 = "von der Liste";
/** @export */ Blockly.Msg.OXOCARD_PUS_HAS_VARIABLE_TITLE1 = "ist nichtflüchtige Variable";
/** @export */ Blockly.Msg.OXOCARD_PUS_HAS_VARIABLE_TITLE2 = "gesetzt?";
/** @export */ Blockly.Msg.OXOCARD_PUS_HAS_VARIABLE_TIP = "Prüft ob die definierte Variable im nichtflüchtigen Speicher gesetzt ist";
/** @export */ Blockly.Msg.OXOCARD_PUS_SET_VARIABLE_TITLE = "Setze nichtflüchtige Variable";
/** @export */ Blockly.Msg.OXOCARD_PUS_SET_VARIABLE_WITH = "mit";
/** @export */ Blockly.Msg.OXOCARD_PUS_SET_VARIABLE_TIP = "Setzt die definierte Variable im nichtflüchtigen Speicher";
/** @export */ Blockly.Msg.OXOCARD_PUS_GET_VARIABLE_TITLE = "lies nichtflüchtige Variable";
/** @export */ Blockly.Msg.OXOCARD_PUS_GET_VARIABLE_TIP = "Liefert den Wert der definierten Variable aus dem nichtflüchtigen Speicher";
/** @export */ Blockly.Msg.OXOCARD_PUS_DELETE_VARIABLE_TITLE = "Lösche nichtflüchtige Variable";
/** @export */ Blockly.Msg.OXOCARD_PUS_DELETE_VARIABLE_TIP = "Löscht die definierte Variable aus dem nichtflüchtigen Speicher";
/** @export */ Blockly.Msg.OXOCARD_LOGIC_OPERATION_AND = "und";
/** @export */ Blockly.Msg.OXOCARD_LOGIC_OPERATION_OR = "oder";
/** @export */ Blockly.Msg.OXOCARD_LOGIC_WHILE_FOREVER_TIP = "Endlose Schleife: Wiederhole die eingesetzten Blöcke für immer";
/** @export */ Blockly.Msg.OXOCARD_LOGIC_WHILE_FOREVER_TITLE = "Wiederhole für immer";
/** @export */ Blockly.Msg.OXOCARD_MATH_DECREMENT_TIP = "Subtrahiert 1 vom Wert der angegebenen Variable";
/** @export */ Blockly.Msg.OXOCARD_MATH_DECREMENT_TITLE = "Subtrahiere 1 von";
/** @export */ Blockly.Msg.OXOCARD_MATH_INCREMENT_TIP = "Addiert 1 zum Wert der angegebenen Variable";
/** @export */ Blockly.Msg.OXOCARD_MATH_INCREMENT_TITLE = "Addiere 1 zu";
/** @export */ Blockly.Msg.OXOCARD_MATH_SET_VAR_WITH_TIP = "Setzt eine Variable mit einem mathematischen Ausdruck (z.B. 1*(5/8))";
/** @export */ Blockly.Msg.OXOCARD_MATH_SET_VAR_WITH_TITLE = "Setze";
/** @export */ Blockly.Msg.OXOCARD_MATH_SET_VAR_WITH_TITLE2 = "mit";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_CLEAR_PIXEL_TIP = "Löscht das Pixel mit den angegebenen Koordinaten";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_CLEAR_PIXEL_TITLE = "Lösche Pixel";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_CLEAR_TIP = "Löscht alle Pixel";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_CLEAR_TITLE = "Lösche alle Pixel";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_COPY_FRAME_BUFFER_CONTENT_DESTI = "von ";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_COPY_FRAME_BUFFER_CONTENT_SOURCE = " nach ";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_COPY_FRAME_BUFFER_CONTENT_TIP = "Kopiert den Inhalt eines Bildspeichers in einen anderen";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_COPY_FRAME_BUFFER_CONTENT_TITLE = "Kopiere Bildspeicherinhalt";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DISABLE_AUTO_UPDATE_TIP = "Zeichnen-Blöcke werden nicht mehr automatisch ausgegeben";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DISABLE_AUTO_UPDATE_TITLE = "Bildspeicher nicht automatisch ausgeben";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_CIRCLE_TIP = "Zeichnet einen Kreis mit angegebenem Mittelpunkt und Radius";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_CIRCLE_TITLE = "Zeichne Kreis";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_IMAGE_TIP = "Zeichnet ein einfarbiges Bild entsprechend der Matrix";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_IMAGE_TITLE = "Zeichne einfarbiges Bild";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_NUMBER_TIP = "Zeichnet eine Zahl aufs Display";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_NUMBER_TITLE = "Zeichne Zahl";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_RECTANGLE_TIP = "Zeichnet ein Rechteck an der angegebenen Position, die x- und y-Koordinate zeigt den Punkt oben links an";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_RECTANGLE_TITLE = "Zeichne Rechteck";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_RGB_IMAGE_TITLE = "Zeichne mehrfarbiges Bild";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_DRAW_TEXT_TIP = "Zeichnet den eingegebenen Text";
...
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_COLOR_VAR_TITLE = "Setze Pixelfarbe";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_FILL_TIP = "Die geometrischen Formen werden ausgefüllt gezeichnet";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_FILL_TITLE = "Füllen";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_FRAME_BUFFER_TIP = "Wählt den Bildspeicher, der verwendet werden soll";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_FRAME_BUFFER_TITLE = "Wähle Bildspeicher";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_NOFILL_TIP = "Die geometrischen Formen werden nicht ausgefüllt gezeichnet";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_NOFILL_TITLE = "Nicht füllen";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_RANDOM_COLOR_TIP = "Die nachfolgenden Blöcke zeichnen in einer zufälligen Farbe";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_SET_RANDOM_COLOR_TITLE = "Setze zufällige Pixelfarbe";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_UPDATE_TIP = "Zeichnet das aktuelle Bild";
/** @export */ Blockly.Msg.OXOCARD_MATRIX_UPDATE_TITLE = "Bildspeicher ausgeben";
...
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_DOWN = "Unten";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_FLAT = "Flach";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_FLAT_FLIPPED = "Flach umgekehrt";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_HALF_DOWN = "Unten geneigt";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_HALF_LEFT = "Links geneigt";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_HALF_RIGHT = "Rechts geneigt";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_HALF_UP = "Oben geneigt";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_LEFT = "Links";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_RIGHT = "Rechts";
/** @export */ Blockly.Msg.OXOCARD_ORIENTATION_UP = "Oben";
/** @export */ Blockly.Msg.OXOCARD_PAIRING_MODE_TIP = "Die Oxocard kann mit einem Blockly verknüpft werden, indem der angezeigte Farbcode im Blockly abgetippt wird";
...
/** @export */ Blockly.Msg.OXOCARD_RANDOM_TIP = "Liefert eine zufällige Zahl zwischen (und mit) dem ersten angegebenen Wert bis (und mit) dem zweiten Wert";
/** @export */ Blockly.Msg.OXOCARD_RANDOM_TITLE1 = "Zufallszahl von";
/** @export */ Blockly.Msg.OXOCARD_RANDOM_TITLE2 = "bis";
/** @export */ Blockly.Msg.OXOCARD_READ_BATTERY_VOLTAGE_TIP = "Liefert die Batteriespannung in Millivolt";
/** @export */ Blockly.Msg.OXOCARD_READ_BATTERY_VOLTAGE_TITLE = "lies Batteriespannung [mV]";
...
/** @export */ Blockly.Msg.OXOCARD_SET_CURSOR_TIP = "Setzt die Anfangsposition des Cursors auf der Matrix";
/** @export */ Blockly.Msg.OXOCARD_SET_CURSOR_TITLE = "Setze Cursor";
/** @export */ Blockly.Msg.OXOCARD_SET_PIN_MODE_TIP = "Setzt den Modus des ausgewählten IO Pins";
/** @export */ Blockly.Msg.OXOCARD_SET_PIN_MODE_TITLE = "Setze Pin Modus";
/** @export */ Blockly.Msg.OXOCARD_SMILE_TIP = "Zeichnet ein einfaches Smiley :)";
/** @export */ Blockly.Msg.OXOCARD_SMILE_TITLE = "Zeichne Smiley :)";
...
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_TIP = "Ruft die Uhrzeit der angegebenen Zeitzone ab";
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_FROM_TITLE = "Benutze Zeitzone von ";
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_MILLIS_TIP = "Liefert die vergangenen Millisekunden seit Programmbeginn";
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_MILLIS_TITLE = "Millisekunden seit Programmbeginn";
...
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_VALUE_SECOND = "Sekunde";
/** @export */ Blockly.Msg.OXOCARD_TIME_GET_VALUE_TIP = "Liefert einen Wert der Zeit (z.B. Minuten)";
...
/** @export */ Blockly.Msg.OXOCARD_TIME_SET_MANUAL_HOUR = "Stunden";
/** @export */ Blockly.Msg.OXOCARD_TIME_SET_MANUAL_MINUTE = "Minuten";
/** @export */ Blockly.Msg.OXOCARD_TIME_SET_MANUAL_SECOND = "Sekunden";
/** @export */ Blockly.Msg.OXOCARD_TIME_SET_MANUAL_TIP = "Aktualisiert die interne Uhr der Oxocard";
/** @export */ Blockly.Msg.OXOCARD_TIME_SET_MANUAL_TITLE = "Setzte interne Uhr auf";
/** @export */ Blockly.Msg.OXOCARD_TIME_UPDATE_TIP = "Aktualisiert die Uhrzeit der Oxocard mit dem Internet";
...
/** @export */ Blockly.Msg.OXOCARD_TONE_NO_DURATION_TIP = "Spielt den angegebenen Ton ab";
/** @export */ Blockly.Msg.OXOCARD_TONE_NO_DURATION_TITLE = "Spiele Ton der Tonleiter";
/** @export */ Blockly.Msg.OXOCARD_TONE_TIP = "Spielt ein Ton der Tonleiter für die angegebene Dauer (in Millisekunden)";
/** @export */ Blockly.Msg.OXOCARD_TONE_TITLE = "Spiele Ton der Tonleiter";
...
/** @export */ Blockly.Msg.OXOCARD_UPDATE_TIP = "Versetzt die Oxocard in den Update-Modus. Wenn ein Programm im Blockly bereitgestellt wurde, wir dieses anschliessend auf die Oxocard geladen";
/** @export */ Blockly.Msg.OXOCARD_UPDATE_TITLE = "Oxocard aktualisieren";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_DRAW_ICON_TIP = "Zeichnet das Wetter-Icon des nächsten Tages";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_DRAW_ICON_TITLE = "Zeichne Prognose-Icon";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_AND_DRAW_CITY_TIP = "Zeichnet den Namen der Stadt aus den Wetterdaten";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_AND_DRAW_CITY_TITLE = "Zeichne Stadtname";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_FROM_TIP = "Holt die Wetterdaten von der angegebenen Stadt";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_FROM_TITLE = "Hole Wetterdaten von";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_DEWPOINT = "Taupunkt (°C)";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_HUMIDITY = "Luftfeuchtigkeit (%)";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_PRECIPITATION = "Niederschlag (mm)";
/** @export */ Blockly.Msg.OXOCARD_WEATHER_GET_VALUE_TEMP = "Temperatur (°C)";
...
/** @export */ Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "Liefert den zweiten Wert und verlässt die Funktion, falls der erste Wert wahr ist";
...
/** @export */ Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP = "Liefert den angegebenen Textabschnitt";
...
/** @export */ Blockly.Msg.TEXT_INDEXOF_TOOLTIP = "Findet das erste / letzte Auftreten eines Suchbegriffs in einem Text. Liefert die Position des Begriffs oder %1 falls der Suchbegriff nicht gefunden wurde";
...
/** @export */ Blockly.Msg.TEXT_ISEMPTY_TOOLTIP = "Liefert wahr, falls der Text keine Zeichen enthält ist";
...
/** @export */ Blockly.Msg.TEXT_PRINT_TOOLTIP = "Liefert den Text";
...
/** @export */ Blockly.Msg.VARIABLES_GET_TOOLTIP = "Liefert den Wert der Variable";
